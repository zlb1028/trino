 ...
 * @since 2020-03-30
 */
public interface FileSystemClientFactory
{
    /**
     * Get a {@link FileSystemClient} from a configuration Properties object.
     ...
     * @return A {@link FileSystemClient} object.
     * @throws IOException If any IOException occur reading property files or setup filesystem client.
     */
    FileSystemClient getFileSystemClient(Properties properties)
            throws IOException;

    FileSystemClient getFileSystemClient(Properties properties, Path root)
            throws IOException;
