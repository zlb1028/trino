...
public class FileSystemClientManager
{
    ...
    private static final Map<String, FileSystemClientFactory> fileSystemFactories = new ConcurrentHashMap<>();
    ...
    public void addFileSystemClientFactories(FileSystemClientFactory factory)
    {
     ...
     * @throws IOException
     */
    public FileSystemClient getFileSystemClient(Path root)
            throws IOException
    {
     ...
     * @return a {@link FileSystemClient}
     * @throws IOException exception thrown during constructing the client
     */
    public FileSystemClient getFileSystemClient(String name, Path root)
            throws IOException
    {
        ...
        FileSystemClientFactory factory = fileSystemFactories.get(type);
