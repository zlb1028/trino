 ...
 */
package io.trino.queryeditorui.execution;
...
import io.trino.queryeditorui.execution.ExecutionClient.ExecutionFailureException;
import io.trino.queryeditorui.execution.QueryClient.QueryTimeOutException;
import io.trino.queryeditorui.execution.QueryInfoClient.BasicQueryInfo;
import io.trino.queryeditorui.output.builders.FileTooLargeException;
import io.trino.queryeditorui.output.builders.JobOutputBuilder;
import io.trino.queryeditorui.output.builders.OutputBuilderFactory;
import io.trino.queryeditorui.output.persistors.Persistor;
import io.trino.queryeditorui.output.persistors.PersistorFactory;
import io.trino.queryeditorui.protocol.Job;
import io.trino.queryeditorui.protocol.JobSessionContext;
import io.trino.queryeditorui.protocol.JobState;
        ...
        implements Callable<Job>
{
    ...
    public static QueryStats createNoOpQueryStats()
    {
        ...
        DataSize zeroData = DataSize.of(0, DataSize.Unit.BYTE);
