 ...
 */
package io.trino.queryeditorui.store.files;
...
public class ExpiringFileStore
{
            ...
            throws IOException
    {
        ...
        fileWithMetadataCache.put(key, new FileWithMetadata(file, user, DataSize.of(fileSize, DataSize.Unit.BYTE), DateTime.now()));
    }
