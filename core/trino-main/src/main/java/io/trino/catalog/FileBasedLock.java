...
/**
 * A File-based lock for {@link FileSystemClient}
        ...
        implements Lock
{
     ...
     */
    public static FileBasedLock getLock(FileSystemClient fs, Properties lockProperties)
            throws IOException
    {
     ...
     */
    public FileBasedLock(FileSystemClient fs, Path lockFileDir)
            throws IOException
    {
     ...
     */
    public FileBasedLock(FileSystemClient fs,
                         Path lockFileDir,
