...
import io.trino.spi.filesystem.SupportedFileAttributes;
 ...
 * @since 2020-03-30
 */
public class HdfsFileSystemClient
        extends AbstractWorkspaceFileSystemClient
{
    private static final Logger LOG = Logger.get(HdfsFileSystemClient.class);
     ...
     */
    public HdfsFileSystemClient(HdfsConfig config, Path allowAccessRoot)
            throws IOException
    {
