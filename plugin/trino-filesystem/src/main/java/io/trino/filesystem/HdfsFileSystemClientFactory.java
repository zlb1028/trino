...
/**
 * Factory which provides {@link HdfsFileSystemClient}
 *
 * @since 2020-03-30
 */
        ...
        implements FileSystemClientFactory
{
    ...
    public FileSystemClient getFileSystemClient(Properties properties)
            throws IOException
    {
        return new HdfsFileSystemClient(new HdfsConfig(properties), Paths.get("/"));
    }
    ...
    public FileSystemClient getFileSystemClient(Properties properties, Path root)
            throws IOException
    {
        return new HdfsFileSystemClient(new HdfsConfig(properties), root);
    }
